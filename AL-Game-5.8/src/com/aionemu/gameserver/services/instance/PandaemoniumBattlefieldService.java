...
public class PandaemoniumBattlefieldService {
	...
	/**
	 * Schedules the Pandaemonium Battlefield Instance to be launched at the specified Cron-Time.
	 */
	public void start() {
		String[] times = AutoGroupConfig.PANDAEMONIUMBATTLEFIELD_TIMES.split("\\|");
