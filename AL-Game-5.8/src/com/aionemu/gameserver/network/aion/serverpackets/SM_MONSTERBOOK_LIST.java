 ...
 */
public class SM_MONSTERBOOK_LIST extends AionServerPacket {

    PlayerMonsterbookEntry[] allMonsterbook;
    
    public SM_MONSTERBOOK_LIST(final Player player) {
        allMonsterbook = player.getMonsterbook().getAllMonsterbook();
    }	

	protected void writeImpl(AionConnection con) {
        writeH(allMonsterbook.length);
        for (PlayerMonsterbookEntry playerMonsterbookEntry : allMonsterbook) {
