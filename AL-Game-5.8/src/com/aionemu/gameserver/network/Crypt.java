...
public class Crypt {
	 ...
	 */
	public final static byte staticServerPacketCode = 0x56; // 4.9 => 0x56 || 4.7 | 4.6 | 4.5 => 0x44 | 4.3 => 0x46
	/**
	...
	public final int enableKey() {
		 ...
		 */
		return (key ^ 0xCD92E4D5) + 0x3FF2CCD7; // 5.3 EU
	}
