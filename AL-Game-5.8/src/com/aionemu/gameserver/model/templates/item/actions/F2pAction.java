...
public class F2pAction extends AbstractItemAction {
	...
	public void act(final Player player, final Item parentItem, Item targetItem) {
		...
		PacketSendUtility.sendPacket(player, new SM_ITEM_USAGE_ANIMATION(player.getObjectId().intValue(), 0, parentItem.getObjectId().intValue(), parentItem.getItemId(), 1000, 0));
