 ...
 * @author Falke_34
 */
public class AutoSanctumBattlefieldInstance extends AutoInstance {
    ...
    public void onEnterInstance(Player player) {
        ...
        if (playersInside.size() == 1 && !playersInside.get(0).isInGroup2()) {
            final int intValue = PlayerGroupService.createGroup(playersInside.get(0), player, TeamType.AUTO_GROUP).getObjectId();
    ...
    public void onPressEnter(Player player) {
        ...
        ((SanctumBattlefieldReward) instance.getInstanceHandler().getInstanceReward()).portToPosition(player);
