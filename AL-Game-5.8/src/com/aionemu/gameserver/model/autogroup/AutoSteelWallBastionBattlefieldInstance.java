...
public class AutoSteelWallBastionBattlefieldInstance extends AutoInstance {
	...
	public void onPressEnter(Player player) {
		...
		SteelWallBastionBattlefieldService.getInstance().addCoolDown(player);
		((SteelWallBastionBattlefieldReward) instance.getInstanceHandler().getInstanceReward()).portToPosition(player);
	}
