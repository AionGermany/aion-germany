 ...
 * @author Falke_34
 */
public class AutoBalaurMarchingRouteInstance extends AutoInstance {
	...
	public void onPressEnter(Player player) {
		...
		BalaurMarchingRouteService.getInstance().addCoolDown(player);
		((BalaurMarchingRouteReward) instance.getInstanceHandler().getInstanceReward()).portToPosition(player);
	}
