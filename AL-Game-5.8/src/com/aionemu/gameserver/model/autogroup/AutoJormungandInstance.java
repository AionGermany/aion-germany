 ...
 * @author Falke_34
 */
public class AutoJormungandInstance extends AutoInstance {
	...
	public void onPressEnter(Player player) {
		...
		JormungandService.getInstance().addCoolDown(player);
		((JormungandReward) instance.getInstanceHandler().getInstanceReward()).portToPosition(player);
	}
