...
public class Empowered_MastariusAI2 extends AggressiveNpcAI2 {
	...
	protected void handleSpawned() {
		Npc boss2 = getPosition().getWorldMapInstance().getNpc(235065);
		SkillEngine.getInstance().getSkill(getOwner(), 21779, 1, boss2).useNoAnimationSkill(); // Agent's Rest
		super.handleSpawned();
	...
	protected void handleDied() {
		AgentFightService.getInstance().onMastaReward();
		super.handleDied();
	}
}
