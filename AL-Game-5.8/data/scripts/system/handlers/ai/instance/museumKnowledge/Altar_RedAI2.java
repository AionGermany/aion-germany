 ...
 * @author Rinzler
 */
@AIName("Altar_Red") //731754
public class Altar_RedAI2 extends NpcAI2 {
	...
	protected void handleUseItemFinish(Player player) {
		if (!player.getInventory().decreaseByItemId(185000299, 1)) {
			// 빨간 제단에 흐르고 있는 회복의 기운을 차단하려면 빨간 기운의 책이 필요합니다.
		...
		if (worldPosition.isInstanceMap()) {
			if (worldPosition.getMapId() == 301560000) { // Heart Of Eternity 5.5
				...
				killNpc(worldMapInstance.getNpcs(731754)); // Altar Red.
				killNpc(worldMapInstance.getNpcs(731758)); // Red Altar Energy.
				// 빨간 기운의 책을 사용하였습니다.
				PacketSendUtility.playerSendPacketTime(player, SM_SYSTEM_MESSAGE.STR_MSG_junk_ideternity03_zone2_book_02, 0);
				// 빨간 제단이 차단되어 불굴의 응징자 메이즈렘에게 걸려 있던 회복의 기운 감소되었습니다.
