 ...
 * @author Phantom_KNA
 */
public class _25324TenaciousSpree extends QuestHandler {

	public static final int questId = 25324;

	private final static int[] mobs = { 219795, 219796, 219797, 219798, 219799, 219800, 219794, 219793, 219792, 219791 };
	private final static int[] mobs2 = { 233927, 233921, 233922, 233923, 233924, 233925, 233926, 233928 };
	private final static int[] mobs3 = { 234523, 234273, 234276 };

	public _25324TenaciousSpree() {
		super(questId);
	}
