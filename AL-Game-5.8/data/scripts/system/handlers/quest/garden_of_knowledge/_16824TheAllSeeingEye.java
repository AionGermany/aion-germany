 ...
 * @author Phantom_KNA
 */
public class _16824TheAllSeeingEye extends QuestHandler {

	public _16824TheAllSeeingEye() {
		super(questId);
	}
	...
	public boolean onEnterZoneEvent(QuestEnv env, ZoneName zoneName) {
		return defaultOnEnterZoneEvent(env, zoneName, ZoneName.get("REFUGE_OF_RESTRAINT_301550000"));
	}
}
