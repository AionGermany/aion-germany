 ...
 * @author pralinka
 */
public class _15221AedraAltercation extends QuestHandler {

	private final static int questId = 15221;

	public _15221AedraAltercation() {
		super(questId);
	}
	...
	public boolean onKillInWorldEvent(QuestEnv env) {
		...
		if (env.getVisibleObject() instanceof Player && player != null && player.isInsideZone(ZoneName.get("DRAGON_LORDS_CENTERPIECE_210070000"))) {
