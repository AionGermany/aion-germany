 ...
 * @author Phantom_KNA
 */
public class _27506SkirmishontheBalaurMarchingRoute extends QuestHandler {

	public _27506SkirmishontheBalaurMarchingRoute() {
		super(questId);
	}

	private final static int questId = 27506;

	@Override
	public void register() {
		qe.registerQuestNpc(806268).addOnTalkEvent(questId);
