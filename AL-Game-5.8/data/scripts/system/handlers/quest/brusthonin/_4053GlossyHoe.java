...
public class _4053GlossyHoe extends QuestHandler {
	...
	public void register() {
		qe.registerQuestNpc(205165).addOnTalkEvent(questId);
		qe.registerQuestNpc(205167).addOnTalkEvent(questId);
		qe.registerQuestNpc(205178).addOnTalkEvent(questId);
		qe.registerQuestItem(182209031, questId);
	}
		...
		if (targetId == 0) {
			...
			if (qs != null) {
				if (env.getDialog() == DialogAction.QUEST_SELECT && qs.getStatus() == QuestStatus.START) {
					...
					removeQuestItem(env, 182209031, 1);
					qs.setQuestVar(1);
