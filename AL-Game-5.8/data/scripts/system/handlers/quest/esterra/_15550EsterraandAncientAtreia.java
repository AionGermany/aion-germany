 ...
 * @author Phantom_KNA
 */
public class _15550EsterraandAncientAtreia extends QuestHandler {

	private final static int questId = 15550;

	public _15550EsterraandAncientAtreia() {
		super(questId);
	}
	...
	public void register() {
		...
		qe.registerQuestNpc(806113).addOnTalkEvent(questId); // Volta
