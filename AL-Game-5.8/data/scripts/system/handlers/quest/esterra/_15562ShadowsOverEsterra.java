 ...
 * @author Phantom_KNA
 */
public class _15562ShadowsOverEsterra extends QuestHandler {

	public _15562ShadowsOverEsterra() {
		super(questId);
	}

	private final static int questId = 15562;
	int[] mobs = { 240615, 240616, 240617, 240618, 240631, 240632, 240633, 240634, 240647, 240648, 240649, 240650 };
