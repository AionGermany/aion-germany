 ...
 * @author Phantom_KNA
 */
public class _80935RepeatedAttackonNosra extends QuestHandler {

	public _80935RepeatedAttackonNosra() {
		super(questId);
	}

	private final static int questId = 80935;

	@Override
	public void register() {
		qe.registerQuestNpc(835068).addOnQuestStart(questId); // Ternia
