...
public class _24220WelcometoPanesterra extends QuestHandler {

	private final static int questId = 24220;
	private final static int[] movies = { 904, 905, 906, 907 };

	public _24220WelcometoPanesterra() {
		super(questId);
	}

	@Override
	public void register() {
		qe.registerQuestNpc(802542).addOnQuestStart(questId);
		qe.registerQuestNpc(802542).addOnTalkEvent(questId); // Lander
		qe.registerQuestNpc(802543).addOnTalkEvent(questId); // Ingdora
