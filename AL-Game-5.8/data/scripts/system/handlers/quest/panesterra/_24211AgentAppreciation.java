...
public class _24211AgentAppreciation extends QuestHandler {

	private final static int questId = 24211;

	public _24211AgentAppreciation() {
		super(questId);
	}
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (var == 0) {
				...
				if (targetId == 277224) { // Ahserion.
					Npc npc = (Npc) env.getVisibleObject();
					QuestService.addNewSpawn(400030000, player.getInstanceId(), 804750, npc.getX(), npc.getY(), 675.088f, (byte) 0); // Pasha.
