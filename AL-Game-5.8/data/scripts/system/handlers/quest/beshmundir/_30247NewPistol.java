 ...
 */
public class _30247NewPistol extends QuestHandler {

	private final static int questId = 30247;

	public _30247NewPistol() {
		super(questId);
	}
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
			if (targetId == 799032) { // Gefeios
				if (player.getInventory().getItemCountByItemId(101800651) >= 1) { // Noble Siel's Supreme Pistol
