 ...
 * @author Phantom_KNA
 */
public class _15466ProtectTheUpperAbyss extends QuestHandler {

	private final static int questId = 15466;

	public _15466ProtectTheUpperAbyss() {
		super(questId);
	}
	...
	public boolean onKillInWorldEvent(QuestEnv env) {
		...
		if (env.getVisibleObject() instanceof Player && player != null && player.isInsideZone(ZoneName.get("400010000"))) {
