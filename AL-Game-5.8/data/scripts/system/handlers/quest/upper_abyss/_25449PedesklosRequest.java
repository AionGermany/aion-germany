 ...
 * @author Phantom_KNA
 */
public class _25449PedesklosRequest extends QuestHandler {

	private final static int questId = 25449;

	public _25449PedesklosRequest() {
		super(questId);
	}
	...
	public boolean onKillInWorldEvent(QuestEnv env) {
		...
		if (env.getVisibleObject() instanceof Player && player != null && player.isInsideZone(ZoneName.get("EYE_OF_RESHANTA_ENTRANCE_400010000"))) {
