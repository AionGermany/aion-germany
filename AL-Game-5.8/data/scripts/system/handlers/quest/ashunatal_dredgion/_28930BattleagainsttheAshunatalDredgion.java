 ...
 * @author Phantom_KNA
 */
public class _28930BattleagainsttheAshunatalDredgion extends QuestHandler {

	public static final int questId = 28930;

	int[] navigator = { 243809, 243808 };
	int[] officer = { 243811, 243810 };

	public _28930BattleagainsttheAshunatalDredgion() {
		super(questId);
	}

	@Override
	public void register() {
		qe.registerQuestNpc(806260).addOnQuestStart(questId); // Olivia
		qe.registerQuestNpc(806261).addOnTalkEvent(questId); // Nenati
		qe.registerQuestNpc(806260).addOnTalkEvent(questId); // Olivia
