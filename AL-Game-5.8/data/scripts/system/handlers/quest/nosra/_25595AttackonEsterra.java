 ...
 * @author Phantom_KNA
 */
public class _25595AttackonEsterra extends QuestHandler {

	public _25595AttackonEsterra() {
		super(questId);
	}
	...
	public boolean onKillInWorldEvent(QuestEnv env) {
		Player player = env.getPlayer();
		if (env.getVisibleObject() instanceof Player && player != null && player.isInsideZone(ZoneName.get("220100000"))) {
