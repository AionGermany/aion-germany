...
@AIName("kobold_foreman")
public class KoboldForemanAI2 extends AggressiveNpcAI2 {
	...
	protected void handleSpawned() {
		...
		AI2Actions.targetCreature(KoboldForemanAI2.this, towerCenter);
		getAggroList().addHate(towerCenter, 100000);
		AI2Actions.targetCreature(KoboldForemanAI2.this, tower);
