...
@AIName("Bastiel_Terrarium") // 806702
public class Bastiel_TerrariumAI2 extends GeneralNpcAI2 {
	...
	private void startInvulnerable() {
		final Npc bastielTerrarium = getPosition().getWorldMapInstance().getNpc(806702);
		bastielTerrarium.setTarget(getOwner());
		WorldMapInstance instance = getPosition().getWorldMapInstance();
		for (Player player : instance.getPlayersInside()) {
			if (MathUtil.isIn3dRange(player, bastielTerrarium, 50)) {
