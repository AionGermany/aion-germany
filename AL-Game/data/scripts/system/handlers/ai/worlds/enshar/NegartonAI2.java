...
public class NegartonAI2 extends NpcAI2 {
	...
	protected void handleDialogStart(Player player) {
		if (player.getInventory().getFirstItemByItemId(185000234) != null) { // Cet Territory Village Infiltration Rift Corridor Key
	...
	public boolean onDialogSelect(final Player player, int dialogId, int questId, int extendedRewardIndex) {
		if (dialogId == 10000 && player.getInventory().decreaseByItemId(185000234, 1)) { // Cet Territory Village Infiltration Rift Corridor Key
			switch (getNpcId()) {
