...
public class BestaAI2 extends NpcAI2 {
	...
	protected void handleDialogStart(Player player) {
		if (player.getInventory().getFirstItemByItemId(185000231) != null) { // Aedra Territory Village Infiltration Rift Corridor Key
	...
	public boolean onDialogSelect(final Player player, int dialogId, int questId, int extendedRewardIndex) {
		if (dialogId == 10000 && player.getInventory().decreaseByItemId(185000231, 1)) { // Aedra Territory Village Infiltration Rift Corridor Key
			switch (getNpcId()) {
				case 804843: // Besta
