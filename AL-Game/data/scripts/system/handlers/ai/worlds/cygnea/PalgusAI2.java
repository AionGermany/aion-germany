...
public class PalgusAI2 extends NpcAI2 {
	...
	protected void handleDialogStart(Player player) {
		if (player.getInventory().getFirstItemByItemId(185000232) != null) { // Erivale Territory Village Infiltration Rift Corridor Key
	...
	public boolean onDialogSelect(final Player player, int dialogId, int questId, int extendedRewardIndex) {
		if (dialogId == 10000 && player.getInventory().decreaseByItemId(185000232, 1)) { // Erivale Territory Village Infiltration Rift Corridor Key
			switch (getNpcId()) {
				case 804844: // Palgus
