 ...
 */
public class _13980InstanceGroupLostJotunStudio extends QuestHandler {

	private final static int questId = 13980;
	private final static int[] mobs = { 650016, 650021, 650026 };

	public _13980InstanceGroupLostJotunStudio() {
		super(questId);
	}

	@Override
	public void register() {
		qe.registerQuestNpc(806817).addOnQuestStart(questId); // Stuck Atis
		qe.registerQuestNpc(806817).addOnTalkEvent(questId); // Stuck Atis
