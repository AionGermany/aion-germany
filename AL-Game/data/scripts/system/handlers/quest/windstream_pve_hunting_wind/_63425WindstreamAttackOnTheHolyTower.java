 ...
 */
public class _63425WindstreamAttackOnTheHolyTower extends QuestHandler {

	private final static int questId = 63425;
	private final static int[] mobs = { 654472, 657969 };

	public _63425WindstreamAttackOnTheHolyTower() {
		super(questId);
	}
