 ...
 * @rework FrozenKiller
 */
public class _19070DispatchtoVerteron extends QuestHandler {

	private final static int questId = 19070;

	public _19070DispatchtoVerteron() {
		super(questId);
	}

	@Override
	public void register() {
		qe.registerQuestNpc(801212).addOnQuestStart(questId);
		qe.registerQuestNpc(801212).addOnTalkEvent(questId);
