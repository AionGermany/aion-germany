 ...
 */
public class _23990LeagueAttackOnTheDivineFortress extends QuestHandler {

	private final static int questId = 23990;
	...
	public _23990LeagueAttackOnTheDivineFortress() {
		super(questId);
	}

	@Override
	public void register() {
		qe.registerQuestNpc(835724).addOnQuestStart(questId); // Tanaas
		qe.registerQuestNpc(835724).addOnTalkEvent(questId); // Tanaas
