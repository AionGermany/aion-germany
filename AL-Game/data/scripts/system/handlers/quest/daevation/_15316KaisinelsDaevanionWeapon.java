 ...
 * @author Phantom_KNA
 */
public class _15316KaisinelsDaevanionWeapon extends QuestHandler {

	private final static int questId = 15316;
	int[] mobs = { 233941, 233942, 234692, 234313, 234312, 233900, 233944, 234704 };
	int[] mobs2 = { 234292, 234529, 234296, 234298, 234294 };
	int[] mobs3 = { 883308, 883307, 883305, 883304, 883306, 883302, 883301, 884022 };
	int[] boss = { 236277, 231073, 231130 };

	public _15316KaisinelsDaevanionWeapon() {
		super(questId);
	}
