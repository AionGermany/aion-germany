 ...
 * @author Ghost_KNA
 */
public class _25334APrayerofDevotion extends QuestHandler {

	private final static int questId = 25334;

	public _25334APrayerofDevotion() {
		super(questId);
	}
	...
	public void register() {
		...
		qe.registerQuestNpc(805342).addOnTalkEvent(questId); // Hicai
