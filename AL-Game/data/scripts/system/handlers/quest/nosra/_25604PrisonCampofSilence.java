 ...
 * @author Phantom_KNA
 */
public class _25604PrisonCampofSilence extends QuestHandler {

	public static final int questId = 25604;

	public _25604PrisonCampofSilence() {
		super(questId);
	}
	...
	public void register() {
		...
		qe.registerQuestNpc(703125).addOnKillEvent(questId); // Suffering Guardian
		qe.registerOnEnterZone(ZoneName.get("ALTAR_OF_SILENCE_220110000"), questId);
	...
	public boolean onEnterZoneEvent(QuestEnv env, ZoneName zoneName) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			int var = qs.getQuestVarById(0);
			if (var == 1 && zoneName == ZoneName.get("ALTAR_OF_SILENCE_220110000")) {
