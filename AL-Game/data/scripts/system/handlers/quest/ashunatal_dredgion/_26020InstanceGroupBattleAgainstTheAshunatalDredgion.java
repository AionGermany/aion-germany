 ...
 */
public class _26020InstanceGroupBattleAgainstTheAshunatalDredgion extends QuestHandler {

	private final static int questId = 26020;
	private final static int[] mobs = { 654793, 654806, 654807, 654808, 654809, 654823 };

	public _26020InstanceGroupBattleAgainstTheAshunatalDredgion() {
		super(questId);
	}

	@Override
	public void register() {
		qe.registerQuestNpc(806261).addOnQuestStart(questId); // Nenanti
		qe.registerQuestNpc(806261).addOnTalkEvent(questId); // Nenanti
