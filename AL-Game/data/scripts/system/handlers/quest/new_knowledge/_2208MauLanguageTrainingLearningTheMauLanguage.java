 ...
 */
public class _2208MauLanguageTrainingLearningTheMauLanguage extends QuestHandler {

	private final static int questId = 2208;

	public _2208MauLanguageTrainingLearningTheMauLanguage() {
		super(questId);
	}
	...
	public void register() {
		...
		qe.registerQuestItem(182203205, questId);			 // Mau Secret Remedy
	}
