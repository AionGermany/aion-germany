 ...
 */
public class _72657ThePromiseToRecaptureTheGreatTempleOfLakrum extends QuestHandler {

	private final static int questId = 72657;
	private final static int[] mobs = { 655094, 655095, 655096, 655097, 655098 };

	public _72657ThePromiseToRecaptureTheGreatTempleOfLakrum() {
		super(questId);
	}
	...
	public boolean onKillEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			// (0) Step: 0, Count: 15, Mobs : 655094, 655095, 655096, 655097, 655098
