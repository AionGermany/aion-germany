 ...
 */
public class _62657TheDesireToRecaptureTheGreatTempleOfLakrum extends QuestHandler {

	private final static int questId = 62657;
	private final static int[] mobs = { 655094, 655095, 655096, 655097, 655098 };

	public _62657TheDesireToRecaptureTheGreatTempleOfLakrum() {
		super(questId);
	}
