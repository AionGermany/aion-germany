 ...
 * @author Phantom_KNA
 */
public class _26825TheStormyCliff extends QuestHandler {

	public _26825TheStormyCliff() {
		super(questId);
	}
	...
	public void register() {
		...
		qe.registerQuestNpc(220597).addOnKillEvent(questId); // Locking Mechanism f the 3rd Hall
