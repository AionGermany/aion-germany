...
public class _14210BringDownTheDragon extends QuestHandler {

	private final static int questId = 14210;

	public _14210BringDownTheDragon() {
		super(questId);
	}
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
			// Herailt.
			if (targetId == 802465 || targetId == 802663 || targetId == 802664 || targetId == 802665) {
				switch (dialog) {
					case QUEST_SELECT: {
