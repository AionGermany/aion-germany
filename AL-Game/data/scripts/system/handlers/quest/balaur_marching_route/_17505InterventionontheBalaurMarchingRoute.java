 ...
 * @author Phantom_KNA
 */
public class _17505InterventionontheBalaurMarchingRoute extends QuestHandler {

	public static final int questId = 17505;

	public _17505InterventionontheBalaurMarchingRoute() {
		super(questId);
	}

	@Override
	public void register() {
		qe.registerQuestItem(182216067, questId); // Shugo Potion
		qe.registerQuestNpc(806266).addOnQuestStart(questId); // Seberus
		qe.registerQuestNpc(806270).addOnTalkEvent(questId); // Hiyorinerk
