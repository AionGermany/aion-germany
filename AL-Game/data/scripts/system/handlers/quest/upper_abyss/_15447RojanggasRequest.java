 ...
 * @author Phantom_KNA
 */
public class _15447RojanggasRequest extends QuestHandler {

	private final static int questId = 15447;

	public _15447RojanggasRequest() {
		super(questId);
	}
	...
	public boolean onKillInWorldEvent(QuestEnv env) {
		...
		if (env.getVisibleObject() instanceof Player && player != null && player.isInsideZone(ZoneName.get("MIREN_ISLAND_400010000"))) {
