 ...
 * @author Phantom_KNA
 */
public class _18996TheFragmentoftheColourfulSwamp extends QuestHandler {

	public static final int questId = 18996;

	public _18996TheFragmentoftheColourfulSwamp() {
		super(questId);
	}
	...
	public void register() {
		...
		qe.registerQuestNpc(806252).addOnTalkEvent(questId); // Pavoni
		qe.registerQuestNpc(834034).addOnTalkEvent(questId); // Beius
