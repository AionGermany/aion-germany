 ...
 * @author Phantom_KNA
 */
public class _28997ArtefactGuardianKroban extends QuestHandler {

	private final static int questId = 28997;

	public _28997ArtefactGuardianKroban() {
		super(questId);
	}

	@Override
	public void register() {
		qe.registerQuestNpc(806253).addOnQuestStart(questId); // Viente
