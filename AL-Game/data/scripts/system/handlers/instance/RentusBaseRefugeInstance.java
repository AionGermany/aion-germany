...
public class RentusBaseRefugeInstance extends GeneralInstanceHandler {
	...
	public void onDropRegistered(Npc npc) {
		...
		switch (npcId) {
			case 236300: // Brigade General Vasharti.
				...
				dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 166500002, 1)); // Amplification Stone.
	...
	public void onEnterInstance(Player player) {
		...
		if (spawnRace == null) {
			...
			spawnInfernalDirectFiringGunIDYun();
		}
	}
	...
	private void spawnInfernalDirectFiringGunIDYun() {
	...
	private void reianInfernalSecureBridge() {
