...
public class AionPacketHandlerFactory {
	...
	public AionPacketHandlerFactory() {
		...
		addPacket(new CM_VERSION_CHECK(0xD6, State.CONNECTED)); // 7.x EU
		addPacket(new CM_TIME_CHECK(0xE4, State.CONNECTED, State.AUTHED, State.IN_GAME)); // 7.x EU
		addPacket(new CM_L2AUTH_LOGIN_CHECK(0x158, State.CONNECTED)); // 7.x EU
		addPacket(new CM_MAC_ADDRESS(0x180, State.CONNECTED, State.AUTHED, State.IN_GAME)); // 7.x EU
		addPacket(new CM_CHARACTER_LIST(0x159, State.AUTHED)); // 7.x EU
		addPacket(new CM_PING(0x2F2, State.AUTHED, State.IN_GAME)); // 7.x EU
		addPacket(new CM_MAY_LOGIN_INTO_GAME(0x18D, State.AUTHED)); // 7.x EU
		addPacket(new CM_ENTER_WORLD(0xDE, State.AUTHED)); // 7.x EU
		addPacket(new CM_UI_SETTINGS(0xDC, State.IN_GAME)); // 7.x EU
		...
		addPacket(new CM_SPLIT_ITEM(0x160, State.IN_GAME)); // 7.x EU
		addPacket(new CM_CUSTOM_SETTINGS(0xD2, State.IN_GAME)); // 7.x EU
		addPacket(new CM_PLAY_MOVIE_END(0x127, State.IN_GAME)); // 7.x EU
		addPacket(new CM_LEVEL_READY(0xDF, State.IN_GAME)); // 7.x EU
		...
		addPacket(new CM_QUIT(0xD5, State.AUTHED, State.IN_GAME)); // 7.x EU
		addPacket(new CM_CREATE_CHARACTER(0x16E, State.AUTHED)); // 7.x EU
		addPacket(new CM_CHARACTER_PASSKEY(0x1A5, State.AUTHED)); // 7.x EU
		addPacket(new CM_MOVE(0x106, State.IN_GAME)); // 7.x EU
		addPacket(new CM_CASTSPELL(0xF7, State.IN_GAME)); // 7.x EU
		addPacket(new CM_EMOTION(0x2FD, State.IN_GAME)); // 7.x EU
		addPacket(new CM_TITLE_SET(0x152, State.IN_GAME)); // 7.x EU
		addPacket(new CM_DELETE_ITEM(0x13B, State.IN_GAME)); // 7.x EU
		addPacket(new CM_QUEST_SHARE(0x16B, State.IN_GAME)); // 7.x EU
		addPacket(new CM_DELETE_QUEST(0x126, State.IN_GAME)); // 7.x EU
		addPacket(new CM_ABYSS_RANKING_PLAYERS(0x183, State.IN_GAME)); // 7.x EU
		addPacket(new CM_ABYSS_RANKING_LEGIONS(0x139, State.IN_GAME)); // 7.x EU
		//addPacket(new CM_PRIVATE_STORE(0x133, State.IN_GAME)); // 5.4 EU
		addPacket(new CM_USE_ITEM(0xEB, State.IN_GAME)); // 7.x EU
		addPacket(new CM_TARGET_SELECT(0xE1, State.IN_GAME)); // 7.x EU
		addPacket(new CM_SHOW_DIALOG(0x2FA, State.IN_GAME)); // 7.x EU
		addPacket(new CM_CHECK_NICKNAME(0x184, State.AUTHED)); // 7.x EU
		//addPacket(new CM_PRIVATE_STORE_NAME(0x144, State.IN_GAME)); // 6.x EU
		addPacket(new CM_DELETE_CHARACTER(0x16F, State.AUTHED)); // 7.x EU
		...
		addPacket(new CM_CLOSE_DIALOG(0x2FB, State.IN_GAME)); // 7.x EU
		addPacket(new CM_DIALOG_SELECT(0x2F8, State.IN_GAME)); // 7.x EU
		addPacket(new CM_BUY_ITEM(0x105, State.IN_GAME)); // 7.x EU
		addPacket(new CM_EQUIP_ITEM(0xE8, State.IN_GAME)); // 7.x EU
		addPacket(new CM_TELEPORT_SELECT(0x15B, State.IN_GAME)); // 7.x EU
		addPacket(new CM_LOOT_ITEM(0x162, State.IN_GAME)); // 7.x EU
		addPacket(new CM_QUESTIONNAIRE(0x164, State.IN_GAME)); // 7.x EU
		addPacket(new CM_ATTACK(0xF6, State.IN_GAME)); // 7.x EU
		addPacket(new CM_PET(0xD8, State.IN_GAME)); // 7.x EU
		addPacket(new CM_PET_EMOTE(0xDB, State.IN_GAME)); // 7.x EU
		addPacket(new CM_CHALLENGE_LIST(0x1BF, State.IN_GAME)); // 7.x EU

		// ********************(FRIEND LIST)*********************
		addPacket(new CM_SHOW_FRIENDLIST(0x1A9, State.IN_GAME)); // 7.x EU
		addPacket(new CM_FRIEND_ADD(0x146, State.IN_GAME)); // 7.x EU
		addPacket(new CM_FRIEND_DEL(0x147, State.IN_GAME)); // 7.x EU
		addPacket(new CM_FRIEND_STATUS(0x17D, State.IN_GAME)); // 7.x EU
		addPacket(new CM_FRIEND_EDIT(0x1C6, State.IN_GAME)); // 7.x EU (NEW) (Notiz Friendlist)
		addPacket(new CM_SET_NOTE(0x10C, State.IN_GAME)); // 7.x EU
		addPacket(new CM_MARK_FRIENDLIST(0x14A, State.IN_GAME)); // 5.4
		addPacket(new CM_SHOW_BLOCKLIST(0x161, State.IN_GAME)); // 7.x EU
		addPacket(new CM_BLOCK_ADD(0x169, State.IN_GAME)); // 7.x EU
		addPacket(new CM_BLOCK_DEL(0x17E, State.IN_GAME)); // 7.x EU
		addPacket(new CM_PLAYER_SEARCH(0x176, State.IN_GAME)); // 7.x EU

		// ********************(LEGION)*********************
		addPacket(new CM_LEGION(0x2F3, State.IN_GAME)); // 7.x EU
		...
		addPacket(new CM_LEGION_SEARCH(0x1C3, State.IN_GAME)); // 7.x EU
		...
		addPacket(new CM_LEGION_SEND_EMBLEM_INFO(0x2F1, State.IN_GAME)); // 7.x EU
		...
		addPacket(new CM_LEGION_TABS(0x2F9, State.IN_GAME)); // 7.x EU
		//addPacket(new CM_STONESPEAR_SIEGE(0xE4, State.IN_GAME)); // 5.4 EU

		// ******************(GROUP)******************* (BUGGY)
		addPacket(new CM_FIND_GROUP(0x113, State.IN_GAME)); // 7.x EU
		addPacket(new CM_AUTO_GROUP(0x19F, State.IN_GAME)); // 7.x EU
		addPacket(new CM_INVITE_TO_GROUP(0x134, State.IN_GAME)); // 7.x EU
		//addPacket(new CM_GROUP_DISTRIBUTION(0x134, State.IN_GAME)); // 5.4 EU
		//addPacket(new CM_GROUP_LOOT(0x184, State.IN_GAME)); // 6.x EU
		addPacket(new CM_GROUP_DATA_EXCHANGE(0x111, State.IN_GAME)); // 7.x EU
		addPacket(new CM_DISTRIBUTION_SETTINGS(0x18C, State.IN_GAME)); // 7.x EU
		addPacket(new CM_SHOW_BRAND(0x178, State.IN_GAME)); // 7.x EU (Group Mark Target etc)

		// ******************(BROKER)******************
		addPacket(new CM_BROKER_LIST(0x142, State.IN_GAME)); // 7.x EU
		addPacket(new CM_BROKER_SEARCH(0x143, State.IN_GAME)); // 7.x EU
		...
		addPacket(new CM_BROKER_SETTLE_LIST(0x138, State.IN_GAME)); // 7.x EU
		addPacket(new CM_BROKER_REGISTERED(0x140, State.IN_GAME)); // 7.x EU
		addPacket(new CM_BUY_BROKER_ITEM(0x141, State.IN_GAME)); // 7.x EU
		addPacket(new CM_BROKER_CANCEL_REGISTERED(0x157, State.IN_GAME)); // 7.x EU
		...
		// ******************(SUMMON)******************
		addPacket(new CM_SUMMON_EMOTION(0x19D, State.IN_GAME)); // 7.x EU
		addPacket(new CM_SUMMON_ATTACK(0x192, State.IN_GAME)); // 7.x EU
		addPacket(new CM_SUMMON_CASTSPELL(0x190, State.IN_GAME)); // 7.x EU
		addPacket(new CM_SUMMON_COMMAND(0x14C, State.IN_GAME)); // 7.x EU
		addPacket(new CM_SUMMON_MOVE(0x19C, State.IN_GAME)); // 7.x EU

		// ******************(MAIL)******************
		addPacket(new CM_CHECK_MAIL_SIZE(0x148, State.IN_GAME)); // 7.x EU
		addPacket(new CM_CHECK_MAIL_SIZE2(0x198, State.IN_GAME)); // 7.x EU
		addPacket(new CM_SEND_MAIL(0x14B, State.IN_GAME)); // 7.x EU
		...
		addPacket(new CM_EXCHANGE_LOCK(0x115, State.IN_GAME)); // 7.x EU
		addPacket(new CM_EXCHANGE_CANCEL(0x10B, State.IN_GAME)); // 7.x EU
		addPacket(new CM_EXCHANGE_OK(0x10A, State.IN_GAME)); // 7.x EU
		addPacket(new CM_EXCHANGE_REQUEST(0x101, State.IN_GAME)); // 7.x EU
		...
		addPacket(new CM_HOUSE_EDIT(0x124, State.IN_GAME)); // 7.x EU
		...
		addPacket(new CM_MOVE_IN_AIR(0x107, State.IN_GAME)); // 7.x EU
		addPacket(new CM_VIEW_PLAYER_DETAILS(0x12B, State.IN_GAME)); // 7.x EU
		addPacket(new CM_TELEPORT_DONE(0xD1, State.IN_GAME)); // 7.x EU
		addPacket(new CM_CHARACTER_EDIT(0xC2, State.AUTHED)); // 5.3
		addPacket(new CM_PLAYER_STATUS_INFO(0x137, State.IN_GAME)); // 7.x EU (Mentor etc)
		addPacket(new CM_MANASTONE(0x11C, State.IN_GAME)); // 7.x EU
		...
		addPacket(new CM_REMOVE_ALTERED_STATE(0xF5, State.IN_GAME)); // 7.x EU
		addPacket(new CM_MAY_QUIT(0xCA, State.AUTHED, State.IN_GAME)); // 7.x EU
		addPacket(new CM_REPORT_PLAYER(0x196, State.IN_GAME)); // 7.x EU (Falke 1BD)
		...
		// // ******************(CHAT)******************
		addPacket(new CM_CHAT_AUTH(0x171, State.IN_GAME)); // 7.x EU
		addPacket(new CM_CHAT_MESSAGE_PUBLIC(0xED, State.IN_GAME)); // 7.x EU
		addPacket(new CM_CHAT_GROUP_INFO(0x103, State.IN_GAME)); // 7.x EU
		addPacket(new CM_CHAT_MESSAGE_WHISPER(0xE2, State.IN_GAME)); // 7.x EU
		addPacket(new CM_CHAT_PLAYER_INFO(0xE9, State.IN_GAME)); // 7.x EU

		// ********************(WEAPON/ARMOR TUNE)*********************
		addPacket(new CM_TUNE(0x1B2, State.IN_GAME)); // 7.x EU
		...
		//addPacket(new CM_LUNA_INSTANCE_ENTRY(0x1CD, State.IN_GAME)); // 7.x EU

		// // ////////////////// MAGIC CRAFT //////////////////
		addPacket(new CM_MAGIC_CRAFT(0x1D3, State.IN_GAME)); // 7.x

		// // /////////////// EQUIPMENT SETTING //////////////////
		addPacket(new CM_EQUIPMENT_SETTING_SAVE(0x1EE, State.IN_GAME)); // 7.x TODO
		addPacket(new CM_EQUIPMENT_SETTING_USE(0x1EF, State.IN_GAME)); // 7.x TODO

		// // //////////////// DAEVANION SKILL //////////////////
		addPacket(new CM_DAEVANION_SKILL_ENCHANT(0x1EA, State.IN_GAME)); // 7.x TODO
		addPacket(new CM_DAEVANION_SKILL_FUSION(0x1EB, State.IN_GAME)); // 7.x TODO

		// // /////////////////// GM PACKET ////////////////////
		addPacket(new CM_GM_COMMAND_SEND(0x2FC, State.IN_GAME)); // 7.x EU
		addPacket(new CM_GM_BOOKMARK(0x2FF, State.IN_GAME)); // 7.x EU

		// // ////////////////// UNK PACKET ////////////////////
		addPacket(new CM_UNK_122(0x122, State.AUTHED)); // 7.x EU
		...
		addPacket(new CM_RANK_LIST(0x1E7, State.IN_GAME)); // 7.x EU TODO
		addPacket(new CM_MY_DOCUMENTATION(0x1E4, State.IN_GAME)); // 7.x EU TODO

		// // /////////////////////////////////////////////////
		addPacket(new CM_SECURITY_TOKEN(0x1A8, State.IN_GAME)); // 7.x EU
		...
		addPacket(new CM_NEVIWIND_CANYON(0x1EC, State.IN_GAME)); // 7.x EU TODO
		addPacket(new CM_TRANSFOMATION(0x1E3, State.IN_GAME)); // 7.x TODO
		addPacket(new CM_CUBIC(0x1D8, State.IN_GAME)); // 7.x EU TODO
		//addPacket(new CM_ATREIAN_PASSPORT(0x1CF, State.IN_GAME)); // 7.x EU TODO
		addPacket(new CM_STIGMA(0x1F5, State.IN_GAME)); // 7.x TODO
		addPacket(new CM_REMOVE_DYE(0x1DA, State.IN_GAME)); // 7.x EU TODO
	}
