...
public enum WorldMapType {
    ...
    IDSEAL_H(302700000),
    SHATTERED_ABYSSAL_SPLINTER_2(302710000),
    IDTAG_WAR(302730000),
    IDF7_ERE_S(302800000),
    IDF8_DRAGON_ALTAR(302810000),
    IDF8_DRAGON_ALTAR_E(302820000),
    IDF8_DRAGON_ALTAR_S(302830000),
    IDF8_HOUSE_S(302840000),
    IDF4RE_DRANA_EVENT(302850000),
