...
public enum WorldMapType {
    ...
    //GELKMAROS(220140000),
    SILENTERA_CANYON_E(600010000),
    TIAMARANTAS_EYE_E(600040000),
    TIAMARANTAS_EYE_A(600041000),
    AKARON(600100000),
    SILENTERA_CANYON_A(600110000),
    KALDOR(800020000),
    RED_KATALAM_NORTH(800030000),
    RED_KATALAM_SOUTH(800040000),
    LAKRUM(800050000),
    DUMAHA(800060000),
    // Abyss
    RESHANTA(400010000),
    ...
    BESHMUNDIR_STORM_TEMPLE_NORMAL_L(300170000),
    ...
    UNSTABLE_HALL_OF_KNOWLEDGE(300480000),
    BATTLEFIELD_OF_SURVIVAL(300490000),
    EVENT_INSTANCE(300500000),
    TIAMATS_FORTRESS(300510000),
    TIAMATS_HIDEOUT_L(300520000),
    ...
    TIAMATS_HIDEOUT_D(300630000),
    CORRIDOR_OF_BETRAYAL(300700000),
    KATALAMIZE(300800000),
    BESHMUNDIR_STORM_TEMPLE_NORMAL_D(300910000),
    BESHMUNDIR_STORM_TEMPLE_EASY(300920000),
    ...
    MAKARNA_OF_BITTERNESS_NORMAL(301390000),
    ...
    EVENT_SECRET_HELLPATH(301632000),
    ...
    SILENTERA_CANYON_2(302440000),
    TOWER_OF_CHALLENGE(302450000),
    KUBRINERKS_MONSTER_CUBE_LABORATORY(302460000),
    ...
    SENEKTA(302510000),
    STEEL_RAKE_FORTRESS_BONUS(302520000),
    ILLUMIEL(302530000),
    ...
    HIDDEN_MINIONITE_WAREHOUSE(302641000),
    PC_INSTANCE(302642000),
    EVENT_GREENHAVEN_GARDEN(302650000),
    STELLA_PRIVATE_STADIUM(302651000),
    ...
    MAKARNA_OF_BITTERNESS_DIFFICULT(302700000),
    EVENT_SHATTERED_ABYSSAL_SPLINTER(302710000),
    RAGING_VALLEY(302730000),
    RAGING_VALLEY_NORMAL(302740000),
    HELIOTROPIC_CHAMBER(302750000),
    SENEKTA_SOLO(302800000),
    ARA_INFERNALIA_NORMAL(302810000),
    ARA_INFERNALIA_EASY(302820000),
    PC_INSTANCE_1(302830000),
    BENINERKS_MANOR_SOLO(302840000),
    PC_INSTANCE_2(302850000),
    ...
    ALQUIMIA_RESEARCH_CENTRE(320110000),
    ...
    GENESIS_BATTLE_ARENA(320180000),
    ORIEL_B(720010000),
    PERNON_B(730010000),
    // Housing
    ...
    INSTANCE_TEST_DAMAGE_SENEKTA(302720000),
    TEST_BASIC(900020000),
    TEST_SERVER(900030000),
    TEST_ARTSTUDIO(900040000),
    ...
    EYE_OF_RESHANTA(400070000),
    CONCERT_GROUNDS(600080000),
    SECRET_LOCATION(600081000),
    AION_DREAMSCAPE(600082000),
    ABYSS_GAP(610010000),
    MEETING_POINT(800010000),
    TEMPUS_FUGIT(800070000),
    TIAMARANTAS_EYE(800080000),
