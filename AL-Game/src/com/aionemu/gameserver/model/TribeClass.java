...
public enum TribeClass {
    ...
    ESCORT_IDF6_LF1,
    ETTIN,
    EVENT_OCT_BEHOLDER_REAL,
    EVENT_OCT_DEBRIE_POLYMORPH,
    EVENT_SOLO_MONSTER,
    EVENT_SOLO_POLYMORPH,
    EVENT_SOLO_PORGUSS,
    EVENT_SOLO_TOG,
    EVENT_V72_THEWAR,
    EVENT_V72_THEWAR_BBOO,
    EVENT_V75_HAPPYSHUGO,
    ...
    IDF7_WEAPON_PRIGIDA,
    IDF8_DRAGON_ALTAR_FOBJ,
    IDF8_DRAGON_ALTAR_RAID,
    IDF8_DRAGON_ALTAR_USEALL,
    IDF8_HOUSE_BOSS,
    IDF8_HOUSE_FIRE,
    IDF8_MISSION02_D,
    IDF8_MISSION02_L,
    ...
    LDF5_GURURU,
    LDF5_LI_MOB,
    LDF5_LI_MOB_AGGRESSIVE,
    LDF5_LUPYLLINI,
    LDF5_MUTA,
    LDF5_NATIVE_DIRECT,
    LDF5_NEUT,
    LDF5_OWLLAU,
    LDF5_PANDAROONGS_ENTRANCE,
    LDF5_PANDAROONGS_POLYMORPH_D,
    LDF5_PANDAROONGS_POLYMORPH_L,
    LDF5_SHULACK_DIRECT,
    LDF5_SHULACK_KEEPER,
    LDF5_SPAKLE,
    ...
    LDF7_SEP_EVENT_D,
    LDF7_SEP_EVENT_L,
    LDF8_AGGRESSIVESINGLEMONSTER,
    LDF8_DEF_NAKI,
    LDF8_FIELD_OBJECT_ALL,
    LDF8_LEGA,
    LDF8_LEGION_ALL_ATK,
    LDF8_LEGION_DIGGER_D,
    LDF8_LEGION_DIGGER_L,
    LDF8_LEGION_DIGGER_N,
    LDF8_NK,
    LDF8_SNOOWA,
    LDF8_SP_BUFF,
    LDF8_STELLA_L_D,
    ...
    ONLY_GUARD_AGRRESI,
    ORC,
    PANDORARAID_ENERGY_DARK(Race.ASMODIANS),
    PANDORARAID_ENERGY_LIGHT(Race.ELYOS),
    PANDORARAID_WAVE_MONSTER,
    PARENTSMONSTER,
    PC(true),
    PC_DARK(true),
    PC_DRAGON(true),
    ...
    PROTECTGUARD_DRAGON(Race.DRAGON),
