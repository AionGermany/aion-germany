...
public enum AutoGroupType {
	...
	RUNE_SHIELD_TOWER_HEROIC(342, 600000, 6) {
	...
	ELEMENTAL_LORD_LABORATORY(355, 600000, 6) {
	...
	ARKHAL_HIDDEN_SPACE(356, 600000, 6) {
	...
	TIAMAT_HIDDEN_SPACE(408, 600000, 12) {
	...
	public boolean isSteelWall() {
		switch (this) {
			case STEEL_WALL_BASTION_BATTLEFIELD:
				return true;
			default:
				break;
		}
